...
/*
 * ==========================================
 *  ЯНДЕКС СТОП — Главный Game Store
 * ==========================================
...
// Обычные роли: 4 стата со средним 10 (база 10, одному +2, другому -2).
export const GENDERS = {
  'вертолёт': {
    name: 'Боевой вертолёт Апач', emoji: '🚁',
    bonus: 'Скидка на полёты',    penalty: 'Шум в салоне',
    diceType: 20, baseStat: 5,
    stats: { чистота: 15, аккуратность: 15, общение: 15, авторитет: 15, 'Вместе': 'Невозможно вызвать' },
  },
  'разведёнка': {
    name: 'Разведёнка с Прицепом', emoji: '👸',
    bonus: '+3 к детям в машине', penalty: 'Алименты списываются с баланса',
    diceType: 12, baseStat: 3,
    stats: { чистота: 13, аккуратность: 13, общение: 13, авторитет: 13, 'Вместе': 'Жесточайший дебафф' },
  },
  'бабка': {
    name: 'Бабка с Тележкой',    emoji: '👵',
    bonus: 'Проездной на автобус', penalty: 'Тележка занимает 2 места',
    diceType: 12, baseStat: 3,
    stats: { чистота: 13, аккуратность: 13, общение: 13, авторитет: 13, 'Вместе': 'Штраф к вместе' },
  },
  'масик': {
    name: 'Масик',                emoji: '🧸',
    bonus: 'Всегда комфорт плюс', penalty: 'Слишком дорого',
    diceType: 6, baseStat: 2,
    stats: { чистота: 14, аккуратность: 12, общение: 8, авторитет: 6 },
  },
  'тюбик': {
    name: 'Тюбик',                emoji: '🧴',
    bonus: 'Молчаливый водитель', penalty: 'Нет сдачи',
    diceType: 6, baseStat: 2,
    stats: { чистота: 6, аккуратность: 14, общение: 8, авторитет: 12 },
  },
  'скуф': {
    name: 'Истинный скуф',        emoji: '🍺',
    bonus: 'Водитель-братишка',   penalty: 'Платное пиво',
    diceType: 8, baseStat: 3,
    stats: { чистота: 6, аккуратность: 8, общение: 14, авторитет: 12 },
  },
  'гопник': {
    name: 'Культурный гопник',    emoji: '🥀',
    bonus: 'Скидка у ларька',     penalty: 'Водитель боится',
    diceType: 10, baseStat: 4,
    stats: { чистота: 6, аккуратность: 8, общение: 12, авторитет: 14 },
  },
  'программист': {
    name: 'Программист 1С',       emoji: '💻',
    bonus: 'Обновление конфигурации', penalty: 'Не работает в выходных',
    diceType: 6, baseStat: 1,
    stats: { чистота: 8, аккуратность: 14, общение: 6, авторитет: 12 },
  },
  'эльф': {
    name: 'Эльф 80 уровня',       emoji: '🧝',
    bonus: 'Путешествие по лесу', penalty: 'Сложен в общении',
    diceType: 8, baseStat: 2,
    stats: { чистота: 12, аккуратность: 8, общение: 6, авторитет: 14 },
  },
  'неопределился': {
    name: 'Не определился',       emoji: '❓',
    bonus: 'Сюрприз',             penalty: 'Рандомный дебафф',
    diceType: 4, baseStat: 0,
    stats: { чистота: 8, аккуратность: 12, общение: 14, авторитет: 6 },
  },
};
